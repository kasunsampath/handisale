...
app.get('/todos', function (req, res) {
    mc.query('SELECT * FROM tasks', function (error, results, fields) {
        ...
        return res.send({ error: false, data: results, message: 'Todos list.',num:results.length });
    });
});
...
if (error) throw error;
        return res.send({ error: true,  message: 'id not valid' });
}
    });
...
if (error) throw error;
        return res.send({ error: true,  message: 'keyword not found' });
}
    });
